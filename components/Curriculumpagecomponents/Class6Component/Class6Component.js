    ...
    function onSubmitHandler(event) {
        ...
        if(editing_State===true)
        {
            const update_query = {
                query: `
                mutation{
                    updateclass6byid(id:"${form_State.id}",class6:class6_data){
                        id
                    }
                }
            `
            }
            update_query.query = convertJsonToGQL(update_query.query, form_data, "class6_data")
...
export default Class6Component;