    ...
    function onSubmitHandler(event) {
        ...
        if(editing_State===true)
        {
            const update_query = {
                query: `
                mutation{
                    updateclass2byid(id:"${form_State.id}",class2:class2_data){
                        id
                    }
                }
            `
            }
            update_query.query = convertJsonToGQL(update_query.query, form_data, "class2_data")
...
export default Class2Component;