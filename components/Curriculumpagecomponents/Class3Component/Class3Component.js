    ...
    function onSubmitHandler(event) {
        ...
        if(editing_State===true)
        {
            const update_query = {
                query: `
                mutation{
                    updateclass3byid(id:"${form_State.id}",class3:class3_data){
                        id
                    }
                }
            `
            }
            update_query.query = convertJsonToGQL(update_query.query, form_data, "class3_data")
...
export default Class3Component;