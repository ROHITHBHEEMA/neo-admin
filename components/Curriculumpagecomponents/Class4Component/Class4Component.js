    ...
    function onSubmitHandler(event) {
        ...
        if(editing_State===true)
        {
            const update_query = {
                query: `
                mutation{
                    updateclass4byid(id:"${form_State.id}",class4:class4_data){
                        id
                    }
                }
            `
            }
            update_query.query = convertJsonToGQL(update_query.query, form_data, "class4_data")
...
export default Class4Component;