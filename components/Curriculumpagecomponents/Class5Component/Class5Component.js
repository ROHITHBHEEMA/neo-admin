    ...
    function onSubmitHandler(event) {
        ...
        if(editing_State===true)
        {
            const update_query = {
                query: `
                mutation{
                    updateclass5byid(id:"${form_State.id}",class5:class5_data){
                        id
                    }
                }
            `
            }
            update_query.query = convertJsonToGQL(update_query.query, form_data, "class5_data")
...
export default Class5Component;