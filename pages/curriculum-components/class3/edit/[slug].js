...
import Class3Component from "../../../../components/Curriculumpagecomponents/Class3Component/Class3Component";


const Class3Detail = (props) =>{
    ...
    const getdata = () => {
        const query = {
            query: `query{
                           getClass3byid(id:"${router.query.slug}"){
                                id,
                                subjects,
                                chapters,
                            }
        ...
        axios.post("http://localhost:8080/graphql", query, {
            ...
            console.log(res)
            const key_data = res.data.data.getClass3byid;
