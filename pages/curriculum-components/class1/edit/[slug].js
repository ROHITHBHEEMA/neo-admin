...
import Class1Component from "../../../../components/Curriculumpagecomponents/Class1Component/Class1Component";


const Class1Detail = (props) =>{
    ...
    const getdata = () => {
        const query = {
            query: `query{
                           getClass1byid(id:"${router.query.slug}"){
                                id,
                                subjects,
                                chapters,
                            }
        ...
        axios.post("http://localhost:8080/graphql", query, {
            ...
            console.log(res)
            const key_data = res.data.data.getClass1byid;
