...
import Class6Component from "../../../../components/Curriculumpagecomponents/Class6Component/Class6Component";


const Class6Detail = (props) =>{
    ...
    const getdata = () => {
        const query = {
            query: `query{
                           getClass6byid(id:"${router.query.slug}"){
                                id,
                                subjects,
                                chapters,
                            }
        ...
        axios.post("http://localhost:8080/graphql", query, {
            ...
            console.log(res)
            const key_data = res.data.data.getClass6byid;
