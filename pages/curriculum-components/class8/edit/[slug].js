...
import Class8Component from "../../../../components/Curriculumpagecomponents/Class8Component/Class8Component";


const Class8Detail = (props) =>{
    ...
    const getdata = () => {
        const query = {
            query: `query{
                           getClass8byid(id:"${router.query.slug}"){
                                id,
                                subjects,
                                chapters,
                            }
        ...
        axios.post("http://localhost:8080/graphql", query, {
            ...
            console.log(res)
            const key_data = res.data.data.getClass8byid;
