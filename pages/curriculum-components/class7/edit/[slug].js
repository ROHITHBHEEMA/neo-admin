...
import Class7Component from "../../../../components/Curriculumpagecomponents/Class7Component/Class7Component";


const Class7Detail = (props) =>{
    ...
    const getdata = () => {
        const query = {
            query: `query{
                           getClass7byid(id:"${router.query.slug}"){
                                id,
                                subjects,
                                chapters,
                            }
        ...
        axios.post("http://localhost:8080/graphql", query, {
            ...
            console.log(res)
            const key_data = res.data.data.getClass7byid;
