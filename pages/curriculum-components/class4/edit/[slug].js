...
import Class4Component from "../../../../components/Curriculumpagecomponents/Class4Component/Class4Component";


const Class4Detail = (props) =>{
    ...
    const getdata = () => {
        const query = {
            query: `query{
                           getClass4byid(id:"${router.query.slug}"){
                                id,
                                subjects,
                                chapters,
                            }
        ...
        axios.post("http://localhost:8080/graphql", query, {
            ...
            console.log(res)
            const key_data = res.data.data.getClass4byid;
